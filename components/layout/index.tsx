...
export default function Layout(props: LayoutProps) {
  ...
  const meta = {
    title: 'Muhammed Dilaver – Full-Stack Software Developer.',
    description: 'Full-Stack Software Developer and JavaScript enthusiast.',
    type: 'website',
    ...customMeta,
  };
  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:url"
          content={`https://dilaver.ca${router.asPath}`}
        />
        <link
          rel="canonical"
          href={`https://dilaver.ca${router.asPath}`}
        />
        <meta property="og:type" content={meta.type} />
        <meta property="og:site_name" content="Muhammed Dilaver" />
        ...
        <nav className="flex items-center justify-between w-full relative max-w-2xl border-zinc-200 dark:border-zinc-700 mx-auto pt-8 pb-8 sm:pb-16  text-font-dark dark:text-font-light bg-theme-light  dark:bg-theme-dark bg-opacity-60">
          ...
          <div className="">
            ...
            <a
              ...
              href="/muhammed_dilaver_resume.pdf"
              rel="noreferrer"
              target="_blank"
            >
